...
.. _updates: https://docs.djangoproject.com/en/1.4/topics/db/queries/#updating-multiple-objects-at-once
.. _F(): https://docs.djangoproject.com/en/1.4/topics/db/queries/#filters-can-reference-fields-on-the-model
